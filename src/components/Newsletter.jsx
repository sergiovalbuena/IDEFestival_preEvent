      ...
      <Container>
        <div className="relative -mx-4 overflow-hidden bg-indigo-50 py-20 px-4 sm:-mx-6 sm:px-6 md:mx-0 md:rounded-5xl md:px-16 xl:px-24 xl:py-36">
          ...
          <div className="relative mx-auto grid max-w-2xl grid-cols-1 gap-x-32 gap-y-14 xl:max-w-none xl:grid-cols-2">
            <div>
              <p className="font-display text-4xl font-medium tracking-tighter text-green-600 sm:text-5xl">
            ...
            <form>
              <h3 className="text-lg font-semibold tracking-tight text-green-900">
                Get early news for the Festival  <span aria-hidden="true">&darr;</span>
              </h3>
