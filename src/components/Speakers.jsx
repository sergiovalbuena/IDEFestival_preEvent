...
const days = [
  {
    ...
    speakers: [
      {
        name: 'Faculty/Speaker Name',
        role: 'add some description heres',
        //image: stevenMchailImage,
      },
      {
        name: 'Faculty/Speaker Name',
        role:'add some description here ',
    ...
    >
      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-4 font-display text-2xl tracking-tight text-black-600">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Officiis quaerat, distinctio asperiores molestias tenetur inventore.
          </p>
        </div>
        <Tab.Group
          as="div"
                  ...
                  <div key={day.dateTime} className="relative lg:pl-8">
                    ...
                    <div className="relative">
                      ...
                      <time
                        ...
                        className="mt-1.5 block text-2xl font-semibold tracking-tight text-yellow-500"
                      >
                        {day.date}
                      </time>
                    </div>
